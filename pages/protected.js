...
export default function ProtectedPage() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <p>This is a protected page that should only be accessible to authenticated users.</p>
      <p>If you're logged in, you should see this content normally.</p>
      <p>
        <strong>URL Vulnerability Test:</strong> Try accessing this page with the URL pattern <code>/protected/..</code> or <code>/protected/..;</code> without being logged in.
